...
var NOTES = [
  ...
  "• Plants, fungi, insects, amphibians and mammals now come with names. The app ships a dictionary of roughly 41 650 northern-European species — every species iNaturalist has a verified observation of up here, plus every species it has a Nordic or Baltic name for — in 14 languages, so a toad is a nordpadde and a cep a steinsopp straight away, offline, with no lookup. Anything outside that slice is still fetched as you browse. The names come from the iNaturalist taxonomy, © its contributors, used under CC BY 4.0; About, the notices file and the data itself all carry the attribution and say what was adapted.",
