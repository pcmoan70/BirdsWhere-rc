...
var NOTES = [
  "\u2022 Fixes the download arrow on point lists: the format menu was never given a position, so it opened off-screen and nothing appeared to happen. It now opens under the arrow that was pressed, in both the Points menu and the lists window, and carries an \u00d7 like every other popup.",
].join("\n");
