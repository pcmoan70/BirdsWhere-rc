...
var NOTES = [
  ...
  "• Fetching is quick again. Yesterday's fix for the Images list rebuilt the whole gallery every time a source answered — five or six times per fetch, each rebuild starting hundreds of photo loads — which made fetching crawl. It now rebuilds when the fetch settles, or the moment the first data replaces the loading placeholder, and never in between.",
